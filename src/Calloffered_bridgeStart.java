...
public class Calloffered_bridgeStart {
		...
		while (con.connected() == 1) {			
			...
			if(str.equals("CUSTOM")){
				...
				if(str.equals("callcenter::info")){
					...
					if(str.equals("bridge-agent-start")){
						...
						String Query = "Update call_scheduling Set status='Free' , Serving='"+Caller+"', TextualDate='"+evt.getHeader("CC-Member-UUID",-1)+"', CallUUID='"+evt.getHeader("CC-Member-Session-UUID",-1)+"' ";
